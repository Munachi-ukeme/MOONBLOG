  ...
  return (
    <div className={style.aboutContainer}>
      ...
      <section className={style.aboutSection}>
        <h2 className={style.pageHeading}>About Moon Blog</h2>
        <p className={style.leadParagraph}>
      ...
      {/* Narrative Card */}
      <section className={style.aboutSection}>
        <h3 className={style.subHeading}>Our Story</h3>
      ...
      {/* Offerings Checklist Card */}
      <section className={style.aboutSection}>
        <h3 className={style.subHeading}>What You'll Find Here</h3>
      ...
      {/* Styled Advisory / Legal Disclaimer Node */}
      <section className={`${style.aboutSection} ${style.disclaimer}`}>
        <h3 className={style.subHeading}>Disclaimer</h3>
        <p className={style.bodyText}>
      ...
      {/* Community CTA Callout Card */}
      <section className={style.aboutSection}>
        <h3 className={style.subHeading}>Join the Movement</h3>
        <p className={style.bodyText}>
